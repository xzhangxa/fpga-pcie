...
#define INTEL_FPGA_PCIE_IOCTL_GET_KTIMER    _IOR (INTEL_FPGA_PCIE_IOCTL_MAGIC, \
                                                  10, unsigned int *)
#define INTEL_FPGA_PCIE_IOCTL_ALLOCATE_BUFFER  _IOR (INTEL_FPGA_PCIE_IOCTL_MAGIC, \
                                                  11, unsigned int *)
// HSD:15010575718 warning clean up - found that release_buffer function is not used. comment all related lines
/*#define INTEL_FPGA_PCIE_IOCTL_RELEASE_BUFFER  _IOW (INTEL_FPGA_PCIE_IOCTL_MAGIC, \
                                                    12, unsigned int)*/
